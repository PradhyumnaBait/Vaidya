...
export default function RequestStaffAccessPage() {
  ...
  const [department, setDepartment] = useState('OPD Triage')
        ...
        <div className="max-w-md w-full">
          <AuthCard className="text-center">
            ...
            <p className="text-[14px] text-[#71717A] mt-2 mb-6">
              Your request has been sent for hospital staff verification. You will receive access details shortly.
            </p>
            <AuthButton
              variant="primary"
              size="lg"
              className="w-full"
              onClick={() => router.push('/auth/login/nursing')}
            >
              Return to sign in
            </AuthButton>
          </AuthCard>
        ...
        <AuthCard>
          <div className="flex items-center gap-2 mb-4">
            ...
            <div>
              ...
              <p className="text-[12px] text-[#71717A]">Request Staff Access</p>
            </div>
          </div>
          ...
          <p className="text-[13px] text-[#71717A] mt-1 mb-6">
            Enter your hospital staff details to request access.
          </p>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <p className="text-[12px] text-[#A1A1AA] pt-1">
              Access may require hospital staff verification.
            </p>
