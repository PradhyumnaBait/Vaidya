...
const config: Config = {
  ...
  theme: {
    extend: {
      ...
      fontFamily: {
        'page-title': ["'Hanken Grotesk'", "'Plus Jakarta Sans'", 'sans-serif'],
        'section-heading': ["'Hanken Grotesk'", "'Plus Jakarta Sans'", 'sans-serif'],
        'body-compact': ["'Plus Jakarta Sans'", 'sans-serif'],
        'body-primary': ["'Plus Jakarta Sans'", 'sans-serif'],
